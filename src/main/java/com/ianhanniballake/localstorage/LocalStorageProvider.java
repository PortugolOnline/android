...
public class LocalStorageProvider extends DocumentsProvider {
    ...
    public Cursor queryRoots(final String[] projection) throws FileNotFoundException {
        ...
        if (TextUtils.equals(Environment.getExternalStorageState(), Environment.MEDIA_MOUNTED)) {
            ...
            row.add(Root.COLUMN_TITLE, getContext().getString(R.string.armazenamento_interno));
            row.add(Root.COLUMN_FLAGS, Root.FLAG_LOCAL_ONLY | Root.FLAG_SUPPORTS_CREATE | Root.FLAG_SUPPORTS_IS_CHILD);
            row.add(Root.COLUMN_ICON, R.drawable.ic_smartphone_black_48dp);
        ...
        if (TextUtils.equals(storageState, Environment.MEDIA_MOUNTED) ||
            ...
            row.add(Root.COLUMN_ICON, R.drawable.ic_sd_card_black_48dp);
